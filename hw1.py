...
def main():
    ...
    print(get_popular_in_genre('Adventure', create_genre_dict(read_movie_genre('genreMovieSample.txt')),calculate_average_rating(read_ratings_data("movieRatingSample.txt"))))
    pass
